	...
	if(isset($_POST['type'])){
		...
		if($_POST['type']=='accept'){
			if($gateway == 'indianpay'){
				...
				$email = 'withgateway@bdggame.sxmpro.in.net';
			...
			$sqlA = mysqli_query($conn,"Update `hintegedukolli` set sthiti = '2',tike = 'Rejected',dinankavannuracisi = '".$today."' where `shonu`='".$id."'");
