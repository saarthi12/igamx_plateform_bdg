			...
			if($shonusign == $signature){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){
						...
						$data[0]['state'] = 1;
						$data[0]['sort'] = 0;
						$data[0]['categoryImg'] = 'https://apiimages.sxmpro.in.net/BDGWin/lotterycategory/lotterycategory_20240321194458iceq.png';
						...
						$data[1]['state'] = 1;
						$data[1]['sort'] = 0;
						$data[1]['categoryImg'] = 'https://apiimages.sxmpro.in.net/BDGWin/lotterycategory/lotterycategory_20240321194451en5o.png';
						...
						$data[2]['state'] = 1;
						$data[2]['sort'] = 0;
						$data[2]['categoryImg'] = 'https://apiimages.sxmpro.in.net/BDGWin/lotterycategory/lotterycategory_20240321194510h9i1.png';
