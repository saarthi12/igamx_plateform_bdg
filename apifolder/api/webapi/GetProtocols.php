			...
			if($shonusign == $signature){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){																				
						...
						<font color="#ffd663" style="">This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when 
						...
						<font color="#ffd663" style="">Interpretation and Definitions</font></h1>
						<h2 style="box-sizing: inherit; font-family: Futura; margin: 0px; background-repeat: no-repeat; padding: 0px;"><font color="#ffd663" style="">Interpretation</font>
						...
						text-align: start;"><font color="#ffd663" style="">The words of which the initial letter is capitalized have 
						...
						padding: 0px; font-size: 14px; text-align: start;"><font color="#ffd663" style="">The following definitions shall have the same meaning regardless 
						of whether they appear in singular or in plural.</font></p></h3><h2 style="box-sizing: inherit; font-family: Futura; margin: 0px; 
						background-repeat: no-repeat; padding: 0px;"><font color="#ffd663" style="">Definitions</font></h2><h3 class="text-xs-center" style="box-sizing: inherit; 
						font-family: Futura; margin: 0px 0px 12px; background-repeat: no-repeat; padding: 0px; text-align: center !important;">
						<p style="box-sizing: inherit; margin-bottom: 16px; background-repeat: no-repeat; padding: 0px; font-size: 14px; text-align: start;">
						<font color="#ffd663" style="">For the purposes of this Privacy Policy:</font></p><ul style="box-sizing: inherit; margin-right: 0px; margin-bottom: 0px; 
						...
						background-repeat: no-repeat; padding: 0px;"><font color="#ffd663" style=""><span style="box-sizing: inherit; background-repeat: 
						...
						no-repeat; padding: 0px;"><font color="#ffd663" style=""><span style="box-sizing: inherit; background-repeat: no-repeat; padding: 0px; margin: 0px; 
						font-weight: bolder;">Company</span>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to<a href="https://telegram.me/shonuuncensored" 
						target="_blank">BDGGAMEBysXm</a>.</font></p></li><li style="box-sizing: inherit; background-repeat: no-repeat; padding: 0px; margin: 0px;"><font color="#ffd663" 
						...
						background-repeat: no-repeat; padding: 0px; margin: 0px;"><font color="#ffd663" style=""><span style="box-sizing: inherit; background-repeat: no-repeat; 
						...
						</li><li style="box-sizing: inherit; background-repeat: no-repeat; padding: 0px; margin: 0px;"><font color="#ffd663" style="">
						<span style="box-sizing: inherit; background-repeat: no-repeat; padding: 0px; margin: 0px; font-weight: bolder;">Website</span>
						refers to<a href="https://bdggame.sxmpro.in.net" target="_blank">BDGGAMEBysXm</a>, accessible from<a href="https://telegram.me/" 
						target="_blank">BDGGAMEBysXm</a></font></li><li style="box-sizing: inherit; background-repeat: no-repeat; padding: 0px; margin: 0px;">
						<font color="#ffd663" style=""><span style="box-sizing: inherit; background-repeat: no-repeat; padding: 0px; margin: 0px; font-weight: bolder;">
