			...
			if($shonusign == $signature){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){
						...
						$existance = mysqli_query($conn,"SELECT `daysonearth`, `totalblessings` FROM `cihne` WHERE `identity`='".$shonuid."'");
						$data['signIn']['signCount'] = 7;
						$data['signIn']['isCycle'] = 3;
						$data['signIn']['signInSum'] = 4;
						...
						$data['signInRechargesList'][0]['isReceive'] = 1;
						...
						$data['signInRechargesList'][1]['isReceive'] = 1;
						...
						$data['signInRechargesList'][2]['isReceive'] = 1;
						...
						$data['signInRechargesList'][3]['isReceive'] = 1;
						...
						$data['signInRechargesList'][4]['isReceive'] = 1;
						...
						$data['signInRechargesList'][5]['isReceive'] = 1;
						...
						$data['signInRechargesList'][6]['isReceive'] = 1;
